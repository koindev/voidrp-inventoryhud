...
ESX.RegisterServerCallback('voidrp-inventoryhud:getPlayerInventory', function(source, cb)
...
RegisterServerEvent('voidrp-inventoryhud:notifyImpendingRemoval')
AddEventHandler('voidrp-inventoryhud:notifyImpendingRemoval', function(item, count, playerSource)
...
RegisterServerEvent('voidrp-inventoryhud:notifyImpendingAddition')
AddEventHandler('voidrp-inventoryhud:notifyImpendingAddition', function(item, count, playerSource)
    local _source = playerSource or source
...
AddEventHandler('esx:onRemoveInventoryItem', function(source, item, count)
    ...
    TriggerClientEvent('voidrp-inventoryhud:showItemUse', source, {
